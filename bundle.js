function msg_show_ne(message) {
    document.querySelector('.msg').style.display = "block";
    document.querySelector('.msg').innerHTML = `${message}<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    1: [
      function (require, module, exports) {
        ...
        function msg_show(message) {
          ...
          bisnu(
            ".msg"
          ).innerHTML = `${message}<button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>`;
        }
        ...
        check_btn.addEventListener("submit", function (e) {
          ...
          if (isValid) {
            ...
            bisnu(".code_check_and_hide").classList.remove(
              "code_check_and_show"
            );
          }
        });
      ...
      function (require, module, exports) {
        module.exports = (function (A) {
          ...
          return (
            ...
            (I.d = function (A, O, E) {
              I.o(A, O) ||
                Object.defineProperty(A, O, { enumerable: !0, get: E });
            }),
            (I.r = function (A) {
          ...
          function (A, O, I) {
            ...
            O.COMUNI = [
              ...
              [
                "Z717",
                "EE",
                "NUOVE EBRIDI (ISOLE CONDOMINIO FRANCO-INGLESE)",
                0,
              ],
              ["F980", "OR", "NURACHI", 1],
              ["F981", "NU", "NURAGUS", 0],
              ...
              (O.birthplaceFields = function (A, O) {
                ...
                (C.label = "-----------"),
                  ...
                  (I.onchange = function (A) {
                    for (var O = I.value; L.firstChild; )
          ...
          function (A, O, I) {
            ...
            function R(A) {
              return (
                ...
                (function (A, O) {
                  if (!A) return;
                  if ("string" == typeof A) return C(A, O);
            ...
            function G(A, O, I) {
              return O && T(A.prototype, O), I && T(A, I), A;
            }
            var M = (function () {
              function A(O) {
                if (
                  ...
                  if ("object" !== S(O))
                    throw new Error(
                      "Comune constructor accept either a valid string or a plain object. Check the documentation"
                    );
                  var I = O;
                  (this.name = I.name),
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return (
                          A.getCheckCode(I).toUpperCase() === O.toUpperCase()
                        );
                      },
                    },
                    {
                      ...
                      value: function () {
                        for (
                          var O = [],
                            I = (this.code = this.code.slice(0, 15)),
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function (A) {
                        return (
                          isNaN(A) &&
                            (A = (A = R(A).map(function (A) {
                              return isNaN(A) ? N.OMOCODIA_TABLE_INVERSE[A] : A;
                            })).join("")),
                          A
                        );
                      },
            ...
            (M.utils = { birthplaceFields: L.birthplaceFields }),
              (A.exports = M);
          },
          function (A, O, I) {
            "use strict";
            ...
            function T(A, O, I) {
              return O && S(A.prototype, O), I && S(A, I), A;
            }
            var G = (function () {
              function A(O, I, E) {
                var N =
                ...
                if ((C(this, A), N || void 0 === E || void 0 === I)) {
                  ...
                  if (
                    ...
                    throw new Error(
                      "Comune with name ".concat(O, " doesn't exist")
                    );
                  if (void 0 !== E && L.cc !== E)
                    throw new Error(
                      "Comune with cc ".concat(E, " doesn't exist")
                    );
                    ...
                    },
                    {
                      ...
                      value: function (O, I) {
                        ...
                        if (I)
                            ...
                            var error_one = "Comune with name of "
                              .concat(O, " and prov ")
                              .concat(I, " doesn't exists");
                              msg_show_ne(error_one)
                        
                        if (4 === O.length && O.toUpperCase() === O)
                          return A.GetByCC(O);
                        throw new Error(
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function (O) {
                        ...
                        throw new Error(
                          "Comune with cc ".concat(O, " doesn't exist")
                        );
                      },
                    },
                  ]
          ...
          function (A, O, I) {
            "use strict";
            Object.defineProperty(O, "__esModule", { value: !0 }),
              (O.CHECK_CODE_CHARS = O.OMOCODIA_TABLE_INVERSE = O.OMOCODIA_TABLE = O.CHECK_CODE_EVEN = O.CHECK_CODE_ODD = O.MONTH_CODES = void 0);
            O.MONTH_CODES = [
              "A",
              "B",
              "C",
